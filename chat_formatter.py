...
class ChatVartaElbattFormatter:
    ...
    async def get_chat_recommendations(self, plate_number: str) -> Dict:
        ...
        try:
            ...
            # Hent rå matcher
            matched_products, unmatched_batteries = await self.matcher.search_and_match(plate_number)
    ...
    def _format_for_chat(self, matched_products: List[Dict], plate_number: str) -> Dict:
        ...
        try:
            ...
            for battery_type, batteries in battery_groups.items():
                ...
                recommended = [b for b in batteries if b['recommendation'] == 'Anbefalt']
            ...
            return {
                ...
                'message': self._generate_intro_message(plate_number, chat_recommendations)
            }
    ...
    def _generate_intro_message(self, plate_number: str, recommendations: List[Dict]) -> str:
