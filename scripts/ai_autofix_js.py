...
ERROR_MSG = os.environ.get(
    "AI_AUTOFIX_ERROR",
    "Rett denne filen slik at alle tester går grønt med jest/react-scripts. Returner kun gyldig JavaScript.",
)
...
response = openai.ChatCompletion.create(
    model="gpt-4o", messages=[{"role": "user", "content": prompt}], max_tokens=1800
)
